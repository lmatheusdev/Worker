  ...
  return (
    <div className="bg-[#370020] w-[440px] h-[395px] rounded-3xl absolute right-[101px] top-[172px] text-neutral-white p-6">
      ...
      <ul className="flex-col">
        <li className={li_style}><Add/>Técnico: 0.7</li>
        <li className={li_style}><Add/>Chat: 0.4</li>
        <li className={li_style}><Add/>Proativo: 0.3</li>
        <li className={li_style}><Add/>Extra: 2</li>
      </ul>
